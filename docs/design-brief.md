...
│       ├── PullQuote.tsx     (serif italic + teal hairline; default / lead variants)
...
| 11 | Build the five case study visuals (3 diagrams, hero crop, review-agent screenshot) | Pending |
