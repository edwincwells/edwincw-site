...
**Known issue (post-ship, tracked in Prompt 9.1):** mobile view is horizontally scrollable — content overflow introduced during the Prompt 9 build. Desktop composition is correct. To be resolved in the Prompt 9.1 mobile pass alongside the burger-nav work.
...
| 9.1 | Mobile pass — About page overflow fix + homepage mobile nav (burger) | Pending |
